...
// ===== TIMER =====
        ...
        async function completeBlock(){clearInterval(timerInterval);isRunning=false;const wm=Math.floor((totalTime-timeLeft)/60)||1;stats.blocks++;stats.minutes+=wm;stats.streak++;stats.lastDate=new Date().toDateString();saveStats();updateStats();
